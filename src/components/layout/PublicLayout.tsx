            ...
            <header className="sticky top-0 z-50 bg-[#0b0e11/80] backdrop-blur-xl border-b border-primary">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            href="/auth/login"
                            className="text-primary text-sm font-medium hover:text-[#f0b90b] transition-colors px-4 py-2"
                        >
                            Sign In
                        </Link>
                        <Link
                            href="/auth/register"
                            className="bg-binance-yellow text-black text-sm font-bold px-5 py-2.5 rounded-lg hover:bg-[#d4a017] transition-colors shadow-lg shadow-[#f0b90b]/20"
                        >
                            Get Started
                        </Link>
                    </div>
